...
<body>
    ...
    <section class="min-h-screen bg-blue-50 flex justify-center items-center p-8 mt-20">
        <div
    ...
    <form method="POST" action="{{ url('/simulasibiaya') }}" class="space-y-6">
    @csrf

    <!-- Debit Air -->
    <div>
        <label class="block text-gray-700 font-semibold mb-2">Debit air dalam m³</label>
        <input type="number" name="water_flow_rate" placeholder="contoh : 150 m³"
    ...
    <!-- Bak Instalasi -->
    <div>
        <label class="block text-gray-700 font-semibold mb-2">Bak Instalasi</label>
        <div class="flex items-center gap-6">
            <label class="flex items-center space-x-2 cursor-pointer">
                <input type="radio" name="tank_type" value="tanam" checked />
                <span>Bak Tanam</span>
            </label>
            <label class="flex items-center space-x-2 cursor-pointer">
                <input type="radio" name="tank_type" value="fiber" />
                <span>Bak Fiber</span>
            </label>
        </div>
    </div>

    <button type="submit" class="w-full bg-primary text-white ...">
        Simulasi
    </button>
</form>
