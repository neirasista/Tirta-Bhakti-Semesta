...
<body class="bg-gray-100 min-h-screen flex overflow-hidden">
    ...
    <div class="flex items-center justify-center w-1/2 bg-gray-100 p-16">
        <div class="w-full max-w-md p-10 bg-blue-100 rounded-lg shadow-lg">
            ...
            <h2 class="text-3xl font-bold mb-8 text-gray-800 text-center">Ubah Password</h2>

            <form method="POST" action="#">
                @csrf
                <div class="mb-6">
                    <input type="input" name="password" placeholder="Masukkan password baru"
                        class="w-full p-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                        required>
                </div>
                <div class="mb-6">
                    <input type="input" name="password" placeholder="Konfirmasi Password"
                        class="w-full p-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                        required>
                </div>
